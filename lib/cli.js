...
const cli = cac('privy-nuxt-boilerplate')
...
cli
  ...
  .action((outDir = '.', cliOptions) => {
    ...
    if (outDir === '.') {
      console.log(
        chalk`{red Please specify file directory 'npx @privyid/nuxt-boilerplate [folder-name]'}`,
      )
      process.exit(1)
    }

    console.log()
    console.log(chalk`{cyan @privyid/nuxt-boilerplate v${version}}`)
