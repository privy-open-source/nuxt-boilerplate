...
// Types
import { GetAgentsParams, Roles, Users, UsersPagination } from '~/store/users'
...
export default Vue.extend({
  ...
  watch: {
    ...
    options: {
      handler() {
        this.getAgents({
          page: (this.options as TableOptions).page,
          per_page: (this.options as TableOptions).itemsPerPage,
        })
      },
      deep: true,
    },
  ...
  methods: {
    getAgents(options: GetAgentsParams) {
